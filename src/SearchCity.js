    ...
    return(
        <div className='flex justify-center flex-col w-full'>
            ...
            <div className="w-full flex justify-center gap-2 mt-4 mb-1">
                <input
                type="search"
                className="w-1/2 border-2 border-gray-300 px-4 py-2 rounded bg-white"
                placeholder="Enter city to check..."
                value={value}
                onChange={onChange}
                />
                <button onClick={()=> onSearch(value)} className="bg-blue-500 text-white text-lg px-4 py-2 rounded hover:bg-blue-600">
                Search
                </button>
            </div>
